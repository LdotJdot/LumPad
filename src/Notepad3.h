...
#define IDC_TABSTRIP     (0xFB09)
#define IDC_TABBTN_NEW   (0xFB0A)
#define IDC_TABBTN_CLOSE (0xFB0B)
#define IDC_TABROW_FILL  (0xFB0C)
...
#define WM_LUMPAD_DOUBLE_CTRL_FOCUS (WM_APP + 0x182)   // Double-tap Ctrl: bring main window forward
#define WM_LUMPAD_FLUSH_DEFERRED_COPYDATA (WM_APP + 0x183) // Apply queued np3params from WM_COPYDATA (one message per file)
